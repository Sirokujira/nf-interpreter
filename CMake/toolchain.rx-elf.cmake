...
set(TOOLCHAIN_INC_DIR ${TOOLCHAIN_PREFIX}/rx-elf-gcc/include)
set(TOOLCHAIN_LIB_DIR ${TOOLCHAIN_PREFIX}/rx-elf-gcc/lib)
...
macro(SET_COMPILER_VAR var name)
   find_program(CMAKE_${var} rx-elf-gcc-${name} HINTS ${TOOLCHAIN_BIN_DIR} DOC "${name} tool")
endmacro()

# setup C compiler
if(NOT CMAKE_C_COMPILER)
    SET_COMPILER_VAR(C_COMPILER rx-elf-gcc)
endif()

# setup C++ compiler
if(NOT CMAKE_CXX_COMPILER)
    SET_COMPILER_VAR(CXX_COMPILER rx-elf-g++)
endif()

# setup Assembler compiler
if(NOT CMAKE_ASM_COMPILER)
    SET_COMPILER_VAR(ASM_COMPILER rx-elf-gcc)
    SET_COMPILER_VAR(ASM-ATT_COMPILER rx-elf-as)
endif()

# other toolchain configurations
set(CMAKE_OBJCOPY ${TOOLCHAIN_BIN_DIR}/rx-elf-gcc-objcopy CACHE INTERNAL "objcopy tool")
set(CMAKE_OBJDUMP ${TOOLCHAIN_BIN_DIR}/rx-elf-gcc-objdump CACHE INTERNAL "objdump tool")
set(CMAKE_SIZE ${TOOLCHAIN_BIN_DIR}/rx-elf-gcc-size CACHE INTERNAL "size tool")
set(CMAKE_DEBUGER ${TOOLCHAIN_BIN_DIR}/rx-elf-gcc-gdb CACHE INTERNAL "debuger")

# root paths to search on the filesystem for cross-compiling
set(CMAKE_FIND_ROOT_PATH ${TOOLCHAIN_PREFIX}/rx-elf-gcc ${EXTRA_FIND_PATH})
