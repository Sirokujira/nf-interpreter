                                        ...
                                        const enet_buffer_config_t *bufferConfig)
{
    ...
    {
        if ((buffCfg->txBdStartAddrAlign > (volatile enet_tx_bd_struct_t*)0) && (buffCfg->txBufferAlign > (uint8_t*)0))
        {
                                        ...
                                        const enet_buffer_config_t *bufferConfig)
{
    ...
    for (ringNum = 0; ringNum < config->ringNum; ringNum++)
    {
        ...
        if ((buffCfg->rxBdStartAddrAlign > (volatile enet_rx_bd_struct_t*)0) && (buffCfg->rxBufferAlign > (uint8_t *)0))
        {
