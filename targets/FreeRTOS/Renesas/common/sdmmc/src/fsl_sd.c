...
// Portions Copyright 2016-2018 Renesas All rights reserved.
 ...
 * @retval kStatus_Success Operate successfully.
 */
inline static status_t SD_SendApplicationCmd(sd_card_t *card, uint32_t relativeAddress);
 ...
 * @retval kStatus_Success Operate successfully.
 */
inline static status_t SD_GoIdle(sd_card_t *card);
 ...
 * @retval kStatus_Success Operate successfully.
 */
inline static status_t SD_SetBlockSize(sd_card_t *card, uint32_t blockSize);
 ...
 */
inline static status_t SD_ExecuteTuning(sd_card_t *card);
